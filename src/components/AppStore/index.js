...
class AppStore extends Component {
  state = {activeTabItem: tabsList[0].tabId, searchInput: ''}
  ...
  getFilteredProjects = searchResults => {
    ...
    const filteredProjects = searchResults.filter(
      eachApplist => eachApplist.category === activeTabItem,
    )
  ...
  render() {
    ...
    const filteredProject = this.getFilteredProjects(searchResults)
    return (
